"""Train and evaluate ConvNeXt-inspired AripinModified image model."""
...
def train_aripin_modified(
    ...
    *,
    ...
    run_name: str = "aripin_modified",
    metadata: dict[str, Any] | None = None,
    dry_run: bool = False,
) -> dict[str, Any]:
    """Train one AripinModified model and return validation metrics."""
    ...
    model = AripinModified(num_classes=num_classes).to(torch_device)
...
def main() -> None:
    ...
    train_aripin_modified(
        ...
        seed=args.seed,
        device=args.device,
        run_name=f"aripin_modified_{args.protocol}_{args.scope}_seed{args.seed}",
